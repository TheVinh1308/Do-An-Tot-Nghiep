    ...
    return ( <>
        {/* <div className="descbox">
            ...
            <div className="descbox-desc">
                <p>An e-commerce website is an onlune platform that facilitate lorem ipsum dolor, sit amet consectetur adipisicing elit. Necessitatibus, quasi harum molestias eos vero aliquam quo delectus doloribus pariatur, exercitationem omnis incidunt? Inventore error quidem maiores voluptate nobis. Veniam, maxime!</p>
