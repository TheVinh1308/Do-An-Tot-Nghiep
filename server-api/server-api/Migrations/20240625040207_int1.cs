    ...
    public partial class int1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ModPhones", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ModPhones_Brands_BrandId",
                        column: x => x.BrandId,
                        principalTable: "Brands",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ModPhones_Promotions_PromotionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Phones_ModPhones_ModPhoneId",
                        column: x => x.ModPhoneId,
                        principalTable: "ModPhones",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SlideShows_ModPhones_ModPhoneId",
                        column: x => x.ModPhoneId,
                        principalTable: "ModPhones",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Notifications_Phones_PhoneId",
                        column: x => x.PhoneId,
                        principalTable: "Phones",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ModPhones_BrandId",
                table: "ModPhones",
                column: "BrandId");

            migrationBuilder.CreateIndex(
                name: "IX_ModPhones_PromotionId",
                table: "ModPhones",
                column: "PromotionId");

            migrationBuilder.CreateIndex(
                name: "IX_Notifications_PhoneId",
                table: "Notifications",
                column: "PhoneId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Phones_ModPhoneId",
                table: "Phones",
                column: "ModPhoneId");

            migrationBuilder.CreateIndex(
                name: "IX_SlideShows_ModPhoneId",
                table: "SlideShows",
                column: "ModPhoneId");
